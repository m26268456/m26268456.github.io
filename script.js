...
const DEFAULT_PAYMENTS = [
    {
        ...
        rewards: [
			...
			{ merchant: "路易莎咖啡(louisa)", percent: 3.0, note: "" },
	...
	{ 
		...
		rewards: [
			...
			{ merchant: "環球購物中心", percent: 3.0, note: "" },
			{ merchant: "京站時尚廣場", percent: 3.0, note: "" },
			{ merchant: "統一時代百貨", percent: 3.0, note: "" },
			{ merchant: "新光三越", percent: 3.0, note: "" },
			{ merchant: "遠東SOGO", percent: 3.0, note: "" },
			{ merchant: "MITSUI OUTLET PARK", percent: 3.0, note: "" },

			// 咖啡與飲料
			{ merchant: "路易莎咖啡(LOUISA coffee)", percent: 3.0, note: "" },
			{ merchant: "cama café", percent: 3.0, note: "" },
			{ merchant: "星巴克", percent: 3.0, note: "" },
			{ merchant: "康青龍", percent: 3.0, note: "" },
			{ merchant: "COMEBUY", percent: 3.0, note: "" },
			{ merchant: "50嵐", percent: 3.0, note: "" },
			{ merchant: "麻古茶坊", percent: 3.0, note: "" },
			{ merchant: "水巷茶弄", percent: 3.0, note: "" },
			...
			{ merchant: "王品牛排", percent: 3.0, note: "" },
			{ merchant: "享鴨", percent: 3.0, note: "" },
			{ merchant: "肯德基(KFC)", percent: 3.0, note: "" },
			{ merchant: "麥當勞", percent: 3.0, note: "" },
			{ merchant: "必勝客", percent: 3.0, note: "" },
			{ merchant: "漢堡王", percent: 3.0, note: "" },
			{ merchant: "21風味館", percent: 3.0, note: "" },
			{ merchant: "三商炸雞", percent: 3.0, note: "" },
			{ merchant: "麥味登", percent: 3.0, note: "" },
			{ merchant: "迷克夏", percent: 3.0, note: "" },
			{ merchant: "八方雲集", percent: 3.0, note: "" },
			{ merchant: "摩斯漢堡", percent: 3.0, note: "" },

			// 藥妝與家居
			{ merchant: "屈臣氏", percent: 3.0, note: "" },
			{ merchant: "康是美", percent: 3.0, note: "" },
			{ merchant: "寶雅", percent: 3.0, note: "" },
			{ merchant: "丁丁藥局", percent: 3.0, note: "" },
			{ merchant: "大樹藥局", percent: 3.0, note: "" },
			{ merchant: "宜家家居(IKEA)", percent: 3.0, note: "" },
			{ merchant: "無印良品(MUJI)", percent: 3.0, note: "" },
			{ merchant: "小北百貨", percent: 3.0, note: "" },
			{ merchant: "POYA寶雅", percent: 3.0, note: "" },

			// 電子與運動用品
			{ merchant: "神腦國際", percent: 3.0, note: "" },
			{ merchant: "全國電子", percent: 3.0, note: "" },
			{ merchant: "燦坤", percent: 3.0, note: "" },
			{ merchant: "STUDIO A", percent: 3.0, note: "" },
			{ merchant: "NET", percent: 3.0, note: "" },
			{ merchant: "摩曼頓", percent: 3.0, note: "" },
			{ merchant: "Adidas", percent: 3.0, note: "" },
			{ merchant: "NIKE", percent: 3.0, note: "" },
			{ merchant: "迪卡儂", percent: 3.0, note: "" },

			// 加油與娛樂
			{ merchant: "台灣中油", percent: 3.0, note: "" },
			{ merchant: "錢櫃", percent: 3.0, note: "" },
			{ merchant: "湯姆熊歡樂世界", percent: 3.0, note: "" },
			{ merchant: "威秀影城", percent: 3.0, note: "" },

			// 其他零售與服務
			{ merchant: "特力屋", percent: 3.0, note: "" },
			{ merchant: "HOLA", percent: 3.0, note: "" },
			{ merchant: "UNIQLO", percent: 3.0, note: "" },
			{ merchant: "城市車旅", percent: 3.0, note: "" },
			{ merchant: "ChargeSPOT", percent: 3.0, note: "" },
			{ merchant: "LINE GO", percent: 3.0, note: "" },
			{ merchant: "55688(台灣大車隊)", percent: 3.0, note: "" },

			// 旅遊與線上平台
			{ merchant: "UberEats", percent: 3.0, note: "" },
			{ merchant: "巴哈姆特", percent: 3.0, note: "" },
			{ merchant: "KKBOX", percent: 3.0, note: "" },
			{ merchant: "ezTravel易遊網", percent: 3.0, note: "" },
			{ merchant: "雄獅旅遊", percent: 3.0, note: "" },
			{ merchant: "KKday", percent: 3.0, note: "" }
		]
	},
    { 
	...
	{ 
        ...
        rewards: [
			...
			{ merchant: "家樂福", percent: 3.0, note: "" },
			{ merchant: "喜互惠", percent: 3.0, note: "" },
			
			// 生活
			{ merchant: "誠品生活", percent: 3.0, note: "" },
			{ merchant: "台灣中油", percent: 3.0, note: "" },
			{ merchant: "屈臣氏", percent: 3.0, note: "" },
			{ merchant: "康是美", percent: 3.0, note: "" },
			{ merchant: "丁丁連鎖藥妝", percent: 3.0, note: "" },
			{ merchant: "大樹藥局", percent: 3.0, note: "" },
			{ merchant: "台灣大車隊(55688)", percent: 3.0, note: "" },
			...
			{ merchant: "定食8", percent: 3.0, note: "" },
			{ merchant: "麥味登", percent: 3.0, note: "" },
			{ merchant: "六扇門時尚湯鍋", percent: 3.0, note: "" },
			{ merchant: "屋馬", percent: 3.0, note: "" },
			{ merchant: "梁社漢排骨", percent: 3.0, note: "" },
					
            // 日用
			{ merchant: "寶雅(POYA)", percent: 3.0, note: "" },
			{ merchant: "寶家", percent: 3.0, note: "" },
			{ merchant: "九乘九文具專家", percent: 3.0, note: "" },
			{ merchant: "金玉堂", percent: 3.0, note: "" },
			{ merchant: "金石堂", percent: 3.0, note: "" },
			{ merchant: "101文具天堂", percent: 3.0, note: "" },
			{ merchant: "神腦數位", percent: 3.0, note: "" },
                
            // 服飾
			{ merchant: "NET", percent: 3.0, note: "" },
			{ merchant: "鞋全家福", percent: 3.0, note: "" },
			{ merchant: "UNIQLO", percent: 3.0, note: "" },
			{ merchant: "GU", percent: 3.0, note: "" },

			// 共享
			{ merchant: "WeMo", percent: 3.0, note: "" },
			{ merchant: "ChargeSPOT", percent: 3.0, note: "" },

            // 眼鏡
			{ merchant: "德恩堂眼鏡", percent: 3.0, note: "" },
			{ merchant: "小林眼鏡", percent: 3.0, note: "" },
			{ merchant: "仁愛眼鏡", percent: 3.0, note: "" },
			{ merchant: "寶島眼鏡", percent: 3.0, note: "" },

            // 影視
			{ merchant: "秀泰影城", percent: 3.0, note: "" },
