const DEFAULT_CARDS = [
        ...
        groups: [
            ...
            { 
                ...
                rewards: [
					...
					{ merchant: "街口支付", percent: 3.0, note: "不含四大超商" },
					{ merchant: "悠遊付", percent: 3.0, note: "不含四大超商" },
					{ merchant: "全盈+Pay", percent: 3.0, note: "不含四大超商" },
					{ merchant: "全支付", percent: 3.0, note: "不含四大超商、全聯場域" },
					{ merchant: "橘子支付", percent: 3.0, note: "" },
					{ merchant: "等各種支付", percent: 0.0, note: "" },
					{ merchant: "排除以下支付", percent: 999, note: "My FamiPay、PX Pay、Apple Pay、Google Pay、Samsung Pay" },
					
					//線上購物網站
					{ merchant: "PChome", percent: 3.0, note: "" },
					{ merchant: "momo購物網", percent: 3.0, note: "" },
					{ merchant: "蝦皮(Shopee)", percent: 3.0, note: "" },
					{ merchant: "Coupang酷澎", percent: 3.0, note: "" },
					{ merchant: "Yahoo購物中心/拍賣", percent: 3.0, note: "" },
					{ merchant: "淘寶(TaoBao)", percent: 3.0, note: "" },
					{ merchant: "露天", percent: 3.0, note: "不含日本露天" },
					{ merchant: "博客來", percent: 3.0, note: "" },
					{ merchant: "全電商", percent: 3.0, note: "不含全支付、PX Pay付款" },
					{ merchant: "生活市集", percent: 3.0, note: "" },
					{ merchant: "松果購物", percent: 3.0, note: "" },
					{ merchant: "誠品網路書店", percent: 3.0, note: "" },
					{ merchant: "friDay購物", percent: 3.0, note: "" },
					{ merchant: "udn售票網", percent: 3.0, note: "" },
					{ merchant: "GOMAJI", percent: 3.0, note: "" },
					{ merchant: "17Life", percent: 3.0, note: "" },
					{ merchant: "樂天市場", percent: 3.0, note: "" },
					{ merchant: "citiesocial", percent: 3.0, note: "" },
					{ merchant: "91-APP", percent: 3.0, note: "" },
					{ merchant: "媽咪愛", percent: 3.0, note: "" },
					{ merchant: "屈臣氏", percent: 3.0, note: "限線上" },
					{ merchant: "康是美", percent: 3.0, note: "限線上" },
					{ merchant: "家樂福", percent: 3.0, note: "限線上" },
					{ merchant: "神腦", percent: 3.0, note: "限線上" },
					{ merchant: "燦坤", percent: 3.0, note: "限線上" },
					{ merchant: "瘋狂賣客", percent: 3.0, note: "" },
					{ merchant: "myfone購物", percent: 3.0, note: "" },
					{ merchant: "486團購網", percent: 3.0, note: "" },
					{ merchant: "86小舖", percent: 3.0, note: "" },
					{ merchant: "小三美日", percent: 3.0, note: "" },
					{ merchant: "Apple", percent: 3.0, note: "限線上；不含分期" },
					{ merchant: "STUDIO A", percent: 3.0, note: "限線上" },
					{ merchant: "Straight A", percent: 3.0, note: "限線上" },
					{ merchant: "台灣小米", percent: 3.0, note: "限線上" },
					{ merchant: "台灣索尼股份有限公司(Sony)", percent: 3.0, note: "限線上" },
					{ merchant: "良興Eclife購物網", percent: 3.0, note: "" },
					{ merchant: "isunfar愛順發3C購物網", percent: 3.0, note: "" },
					{ merchant: "迪卡儂", percent: 3.0, note: "限線上" },
					{ merchant: "拓元售票系統", percent: 3.0, note: "" },
					{ merchant: "ZARA", percent: 3.0, note: "限線上" },
					{ merchant: "H&M", percent: 3.0, note: "限線上" },
					{ merchant: "GU", percent: 3.0, note: "限線上" },
					{ merchant: "UNIQLO", percent: 3.0, note: "限線上" },
					{ merchant: "OB 嚴選", percent: 3.0, note: "" },
					{ merchant: "lativ米格國際", percent: 3.0, note: "" },
					{ merchant: "GENQUO", percent: 3.0, note: "" },
					{ merchant: "ZALORA", percent: 3.0, note: "" },
					{ merchant: "MOS線上儲值", percent: 3.0, note: "" },
					{ merchant: "星巴克", percent: 3.0, note: "限線上儲值" },
					{ merchant: "ibon售票系統", percent: 3.0, note: "限線上刷卡適用" },
					{ merchant: "ibon mart 統一超商線上購物中心", percent: 3.0, note: "" },
					{ merchant: "EZTABLE", percent: 3.0, note: "" },
					{ merchant: "Pinkoi", percent: 3.0, note: "" },
					{ merchant: "等各種線上購物平台", percent: 0.0, note: "" },
					{ merchant: "排除以下通路", percent: 999, note: "AMAZON、日本露天、東森購物、森森購物" },
					
					//交通/訂房
					{ merchant: "55688", percent: 3.0, note: "限APP" },
					{ merchant: "Uber", percent: 3.0, note: "" },
					{ merchant: "呼叫小黃", percent: 3.0, note: "" },
					{ merchant: "台灣高鐵T-EX行動購票", percent: 3.0, note: "限線上" },
					{ merchant: "台鐵線上購票(台灣鐵路)", percent: 3.0, note: "限線上" },
					{ merchant: "ezTravel", percent: 3.0, note: "" },
					{ merchant: "Agoda", percent: 3.0, note: "" },
					{ merchant: "Hotels.com", percent: 3.0, note: "" },
					{ merchant: "Expedia", percent: 3.0, note: "" },
					{ merchant: "Klook", percent: 3.0, note: "" },
					{ merchant: "kkday", percent: 3.0, note: "" },
					{ merchant: "booking.com", percent: 3.0, note: "" },
					{ merchant: "AIRBNB", percent: 3.0, note: "" },
					{ merchant: "中華航空(華航)", percent: 3.0, note: "" },
					{ merchant: "長榮航空", percent: 3.0, note: "" },
					{ merchant: "台灣虎航", percent: 3.0, note: "" },
					{ merchant: "等各種線上交通/訂房", percent: 0.0, note: "" },
					{ merchant: "排除以下通路", percent: 999, note: "車麻吉月租費、訂房網站延後扣款" },
					
					//外送平台
					{ merchant: "Uber Eats", percent: 3.0, note: "" },
					{ merchant: "foodpanda", percent: 3.0, note: "" },
					{ merchant: "foodomo", percent: 3.0, note: "" },
					{ merchant: "lalamove", percent: 3.0, note: "" },
					{ merchant: "等各種外送平台", percent: 0.0, note: "" },
					{ merchant: "排除以下通路", percent: 999, note: "NA" },
					
					//線上娛樂
					{ merchant: "KKBOX", percent: 3.0, note: "" },
					{ merchant: "iTunes", percent: 3.0, note: "" },
					{ merchant: "Google Play", percent: 3.0, note: "" },
					{ merchant: "Funnow", percent: 3.0, note: "" },
					{ merchant: "等各種線上通路", percent: 0.0, note: "" },
    ...
    },
	{
        name: "方案期限與加碼活動",
        isToggleCard: true,
        cardNote: "信用卡常態回饋與加碼活動",
        groups: [
            { 
                name: "方案期限", 
                needsToggle: true, 
                groupNote: "各信用卡常態回饋之期限", 
                rewards: [
                    { merchant: "台新Richart卡", percent: 0.168, note: "12/31" },
					{ merchant: "玉山Ubear卡", percent: 0.168, note: "26/02/28" },
			...
			{ 
                name: "U Bear 0531", 
                needsToggle: false, 
                groupNote: "251201~260531 網購加碼2%，帳單上限150；新戶申請自動扣繳加碼7%，帳單上限150", 
                rewards: [
					//行動支付
                    { merchant: "LINE Pay", percent: 10.0, note: "不含7-11、全家" },
					{ merchant: "街口支付", percent: 10.0, note: "不含四大超商" },
					{ merchant: "悠遊付", percent: 10.0, note: "不含四大超商" },
					{ merchant: "全盈+Pay", percent: 10.0, note: "不含四大超商" },
					{ merchant: "全支付", percent: 10.0, note: "不含四大超商、全聯場域" },
					{ merchant: "橘子支付", percent: 10.0, note: "" },
					{ merchant: "等各種支付", percent: 0.0, note: "" },
					{ merchant: "排除以下支付", percent: 999, note: "My FamiPay、PX Pay、Apple Pay、Google Pay、Samsung Pay" },
					
					//線上購物網站
					{ merchant: "PChome", percent: 10.0, note: "" },
					{ merchant: "momo購物網", percent: 10.0, note: "" },
					{ merchant: "蝦皮(Shopee)", percent: 10.0, note: "" },
					{ merchant: "Coupang酷澎", percent: 10.0, note: "" },
					{ merchant: "Yahoo購物中心/拍賣", percent: 10.0, note: "" },
					{ merchant: "淘寶(TaoBao)", percent: 10.0, note: "" },
					{ merchant: "露天", percent: 10.0, note: "不含日本露天" },
					{ merchant: "博客來", percent: 10.0, note: "" },
					{ merchant: "全電商", percent: 10.0, note: "不含全支付、PX Pay付款" },
					{ merchant: "生活市集", percent: 10.0, note: "" },
					{ merchant: "松果購物", percent: 10.0, note: "" },
					{ merchant: "誠品網路書店", percent: 10.0, note: "" },
					{ merchant: "friDay購物", percent: 10.0, note: "" },
					{ merchant: "udn售票網", percent: 10.0, note: "" },
					{ merchant: "GOMAJI", percent: 10.0, note: "" },
					{ merchant: "17Life", percent: 10.0, note: "" },
					{ merchant: "樂天市場", percent: 10.0, note: "" },
					{ merchant: "citiesocial", percent: 10.0, note: "" },
					{ merchant: "91-APP", percent: 10.0, note: "" },
					{ merchant: "媽咪愛", percent: 10.0, note: "" },
					{ merchant: "屈臣氏", percent: 10.0, note: "限線上" },
					{ merchant: "康是美", percent: 10.0, note: "限線上" },
					{ merchant: "家樂福", percent: 10.0, note: "限線上" },
					{ merchant: "神腦", percent: 10.0, note: "限線上" },
					{ merchant: "燦坤", percent: 10.0, note: "限線上" },
					{ merchant: "瘋狂賣客", percent: 10.0, note: "" },
					{ merchant: "myfone購物", percent: 10.0, note: "" },
					{ merchant: "486團購網", percent: 10.0, note: "" },
					{ merchant: "86小舖", percent: 10.0, note: "" },
					{ merchant: "小三美日", percent: 10.0, note: "" },
					{ merchant: "Apple", percent: 10.0, note: "限線上；不含分期" },
					{ merchant: "STUDIO A", percent: 10.0, note: "限線上" },
					{ merchant: "Straight A", percent: 10.0, note: "限線上" },
					{ merchant: "台灣小米", percent: 10.0, note: "限線上" },
					{ merchant: "台灣索尼股份有限公司(Sony)", percent: 10.0, note: "限線上" },
					{ merchant: "良興Eclife購物網", percent: 10.0, note: "" },
					{ merchant: "isunfar愛順發3C購物網", percent: 10.0, note: "" },
					{ merchant: "迪卡儂", percent: 10.0, note: "限線上" },
					{ merchant: "拓元售票系統", percent: 10.0, note: "" },
					{ merchant: "ZARA", percent: 10.0, note: "限線上" },
					{ merchant: "H&M", percent: 10.0, note: "限線上" },
					{ merchant: "GU", percent: 10.0, note: "限線上" },
					{ merchant: "UNIQLO", percent: 10.0, note: "限線上" },
					{ merchant: "OB 嚴選", percent: 10.0, note: "" },
					{ merchant: "lativ米格國際", percent: 10.0, note: "" },
					{ merchant: "GENQUO", percent: 10.0, note: "" },
					{ merchant: "ZALORA", percent: 10.0, note: "" },
					{ merchant: "MOS線上儲值", percent: 10.0, note: "" },
					{ merchant: "星巴克", percent: 10.0, note: "限線上儲值" },
					{ merchant: "ibon售票系統", percent: 10.0, note: "限線上刷卡適用" },
					{ merchant: "ibon mart 統一超商線上購物中心", percent: 10.0, note: "" },
					{ merchant: "EZTABLE", percent: 10.0, note: "" },
					{ merchant: "Pinkoi", percent: 10.0, note: "" },
					{ merchant: "等各種線上購物平台", percent: 0.0, note: "" },
					{ merchant: "排除以下通路", percent: 999, note: "AMAZON、日本露天、東森購物、森森購物" },
					
					//交通/訂房
					{ merchant: "55688", percent: 10.0, note: "限APP" },
					{ merchant: "Uber", percent: 10.0, note: "" },
					{ merchant: "呼叫小黃", percent: 10.0, note: "" },
					{ merchant: "台灣高鐵T-EX行動購票", percent: 10.0, note: "限線上" },
					{ merchant: "台鐵線上購票(台灣鐵路)", percent: 10.0, note: "限線上" },
					{ merchant: "ezTravel", percent: 10.0, note: "" },
					{ merchant: "Agoda", percent: 10.0, note: "" },
					{ merchant: "Hotels.com", percent: 10.0, note: "" },
					{ merchant: "Expedia", percent: 10.0, note: "" },
					{ merchant: "Klook", percent: 10.0, note: "" },
					{ merchant: "kkday", percent: 10.0, note: "" },
					{ merchant: "booking.com", percent: 10.0, note: "" },
					{ merchant: "AIRBNB", percent: 10.0, note: "" },
					{ merchant: "中華航空(華航)", percent: 10.0, note: "" },
					{ merchant: "長榮航空", percent: 10.0, note: "" },
					{ merchant: "台灣虎航", percent: 10.0, note: "" },
					{ merchant: "等各種線上交通/訂房", percent: 0.0, note: "" },
					{ merchant: "排除以下通路", percent: 999, note: "車麻吉月租費、訂房網站延後扣款" },
					
					//外送平台
					{ merchant: "Uber Eats", percent: 10.0, note: "" },
					{ merchant: "foodpanda", percent: 10.0, note: "" },
					{ merchant: "foodomo", percent: 10.0, note: "" },
					{ merchant: "lalamove", percent: 10.0, note: "" },
					{ merchant: "等各種外送平台", percent: 0.0, note: "" },
					{ merchant: "排除以下通路", percent: 999, note: "NA" },
					
					//線上娛樂
					{ merchant: "KKBOX", percent: 10.0, note: "" },
					{ merchant: "iTunes", percent: 10.0, note: "" },
					{ merchant: "Google Play", percent: 10.0, note: "" },
					{ merchant: "Funnow", percent: 10.0, note: "" },
					{ merchant: "等各種線上通路", percent: 0.0, note: "" },
					{ merchant: "排除以下情況", percent: 999, note: "定期定額扣繳、Disney+、nitando、PlayStation、Netflix" },
					
					//排除項目
					{ merchant: "全聯場域", percent: 999, note: "" },
					{ merchant: "全家便利商店", percent: 999, note: "" },
					{ merchant: "7-11", percent: 999, note: "" },
					{ merchant: "OK Mart(OK超商/OKMart)", percent: 999, note: "" },
					{ merchant: "Hi-Life萊爾富", percent: 999, note: "" },
...
const DEFAULT_PAYMENTS = [
    {
        ...
        rewards: [
			...
			{ merchant: "OKmart(OK超商)", percent: 6.0, note: "" },
			...
			{ merchant: "路易莎咖啡", percent: 10.0, note: "" },
	...
	{ 
		...
		rewards: [
			...
			// 咖啡與飲料
			{ merchant: "路易莎咖啡(LOUSIA coffee)", percent: 10.0, note: "" },
			{ merchant: "cama café", percent: 10.0, note: "" },
